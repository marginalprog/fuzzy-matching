    ...
    try:
        while True:
            ...
            if choice == '0':
                ...
                print(f"{Colors.GREEN}python -m fuzzy_matching.cli.process_data --mode match --input1 fuzzy_matching/cli/data/input/test_ru_ru_original.json --format1 json --input2 fuzzy_matching/cli/data/input/test_ru_ru_variant.json --format2 json --match-fields \"Фамилия:0.4:false:TOKEN_SORT,Имя:0.3:false:PARTIAL_RATIO,Отчество:0.2:false:RATIO,email:0.1:false:RATIO\" --threshold 0.7 --output-matches fuzzy_matching/cli/data/output/matches.json --output-path fuzzy_matching/cli/data/output/consolidated.json --transliteration-standard \"Passport\" --verbose{Colors.ENDC}", end="")

                print(f"\n{Colors.BOLD}Запуск утилиты сопоставления данных...{Colors.ENDC}")
                print(f"{Colors.YELLOW}Пример 1: Сопоставление англоязычных данных с англоязычными полями{Colors.ENDC}")
                print(f"{Colors.GREEN}python -m fuzzy_matching.cli.process_data --mode match --input1 fuzzy_matching/cli/data/input/test_en_en_original.json --format1 json --input2 fuzzy_matching/cli/data/input/test_en_en_variant.json --format2 json --match-fields \"LastName:0.4:false:TOKEN_SORT,FirstName:0.3:false:PARTIAL_RATIO,MiddleName:0.2:false:RATIO,email:0.1:false:RATIO\" --threshold 0.7 --output-matches fuzzy_matching/cli/data/output/matches.json --output-path fuzzy_matching/cli/data/output/consolidated.json --transliteration-standard \"Passport\" --verbose{Colors.ENDC}", end="")
                ...
                print(f"{Colors.GREEN}python -m fuzzy_matching.cli.process_data --mode transliterate --input1 fuzzy_matching/cli/data/input/test_ru_ru_original.json --format1 json --target-lang en --transliterate-fields \"Фамилия,Имя,Отчество\" --transliteration-standard \"Passport\" --output-path fuzzy_matching/cli/data/output/transliterated_en.json --verbose{Colors.ENDC}", end="")
                ...
                print(f"   {Colors.GREEN}python -m fuzzy_matching.cli.process_data --mode transliterate --input1 fuzzy_matching/cli/data/input/test_ru_ru_original.json --format1 json --target-lang en --output-path fuzzy_matching/cli/data/output/transliterated_en.json --transliterate-fields \"Фамилия,Имя,Отчество\" --transliteration-standard \"Passport\" --verbose{Colors.ENDC}", end="")
