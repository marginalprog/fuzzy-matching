...
GOST_EN_TO_RU_MAP = {v: k for k, v in GOST_779_MAP.items()}

# Научная транслитерация (по стандарту Библиотеки Конгресса США)
SCIENTIFIC_MAP = {
    'а': 'a', 'б': 'b', 'в': 'v', 'г': 'g', 'д': 'd', 'е': 'e', 'ё': 'ë', 
    'ж': 'zh', 'з': 'z', 'и': 'i', 'й': 'ĭ', 'к': 'k', 'л': 'l', 'м': 'm', 
    'н': 'n', 'о': 'o', 'п': 'p', 'р': 'r', 'с': 's', 'т': 't', 'у': 'u', 
    'ф': 'f', 'х': 'kh', 'ц': 'ts', 'ч': 'ch', 'ш': 'sh', 'щ': 'shch', 'ъ': '″', 
    'ы': 'y', 'ь': '′', 'э': 'ė', 'ю': 'i͡u', 'я': 'i͡a',
    'А': 'A', 'Б': 'B', 'В': 'V', 'Г': 'G', 'Д': 'D', 'Е': 'E', 'Ё': 'Ë', 
    'Ж': 'Zh', 'З': 'Z', 'И': 'I', 'Й': 'Ĭ', 'К': 'K', 'Л': 'L', 'М': 'M', 
    'Н': 'N', 'О': 'O', 'П': 'P', 'Р': 'R', 'С': 'S', 'Т': 'T', 'У': 'U', 
    'Ф': 'F', 'Х': 'Kh', 'Ц': 'Ts', 'Ч': 'Ch', 'Ш': 'Sh', 'Щ': 'Shch', 'Ъ': '″', 
...
# Обратное отображение для паспортной транслитерации (только однозначные соответствия)
